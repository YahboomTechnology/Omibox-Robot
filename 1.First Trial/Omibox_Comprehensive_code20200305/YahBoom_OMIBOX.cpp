...
YahBoom_OMIBOX_Voltage::YahBoom_OMIBOX_Voltage(byte pin)
{
    pinName = pin;
}
...
bool YahBoom_OMIBOX_Color::YahBoom_OMIBOX_Identify_Color(byte color)
{
 ...
 if(Red >= 1100 && Red <= 2500 && Green >= 900 && Green <= 2100 && Blue >= 100 && Blue <= 1000)
  {
    Red = 255;
    Green = 0;
    Blue = 0;
  ...
  else if(Red >= 450 && Red <= 1200 && Green >= 800 && Green <= 2000 && Blue >= 500 && Blue <= 1100) 
  ...
  else if(Red >= 400 && Red <= 1200 && Green >= 1500 && Green <= 3000 && Blue >= 1100 && Blue <= 3000)
  {
    Red = 0;
    Green = 0;
    Blue = 255;
  ...
  else if(Red >= 2500 && Green >= 5000 && Blue >= 2600 ) 
  {
    Red = 0;
    Green = 0;
    Blue = 0;
...
//Output color recognition sensor detected Red value
...
//Output color recognition sensor detected Green value
...
//Output color recognition sensor detected Blue value
